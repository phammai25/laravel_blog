      ...
      <div class="col-md-3 left_col">
        ...
        @foreach ($user as $arr)
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><i class="fa fa-bars"></i> <?php echo $arr['name']?><small>Float right</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <div class="col-xs-9">
                      ...
                      <div class="tab-content">
                        ...
                        <div class="tab-pane" id="messages-r">Post Tab.</div>
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-right">
                        ...
                        <li class="active"><a href="#profile-r" data-toggle="tab" aria-expanded="true">Profile</a>
                        </li>
                        <li><a href="#messages-r" data-toggle="tab">Post</a>
                        </li>
                        <li><a href="#messages-r" data-toggle="tab">Post</a>
                        </li>
