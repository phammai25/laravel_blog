        ...
        <div class="top_nav">
         ...
         <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <a href="{{url('admin/')}}"><h2><i class="fa fa-align-left"></i>HOME<small>Sessions</small></h2>
                    ...
                    @foreach ($post as $arr)
                      <div class="panel">
                        <div class="panel-heading collapsed"  aria-controls="collapseOne">
                          <h4 class="panel-title"><a href="{{url('/admin/deletepost/'.$arr['id'])}}"  ><?php echo $arr['tag']?></a></h4>
                        </div>
                       </div>
                    @endforeach 
